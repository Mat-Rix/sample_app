...
describe UsersController do
  ...
  describe "POST create" do
    ...
    describe "success" do
      ...
      before(:each) do
        @attr = { :name => "New User", :email => "user@company.com",
  ...
  describe "PUT 'update'" do
    ...
    describe "success" do
      ...
      before(:each) do
        @attr = { :name => "New Name", :email => "user12@company.com",
  ...
  describe "DELETE 'destroy'" do
    ...
    describe "as a admin user" do
      ...
      before(:each) do
        @admin = Factory(:user, :email => "admin@company.com", :admin => true)
        test_sign_in(@admin)
      end
  ...
  describe "follow pages" do
    ...
    describe "when signed in" do
      ...
      it "should show user followers" do
        get :followers, :id => @other
        response.should have_selector('a', :href => user_path(@ser),
                                      :content => @user.name)
      end
